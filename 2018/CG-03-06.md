...
1. Proposals and discussions
    ...
    1. HTML serialization of WebAssembly.Module objects (Daniel Ehrenberg)
       ...
       * Where should this be in the process?
    1. GCs in linear memory (Brad Nelson - low priority if we still have time)
       * Several ports to wasm including Mono and Go have started to explore doing their own GC.
       * Given this has potential performance and cross-gc cycle issues, how are folks feeling about this?
       * Mainly intended to gauge interest.
1. Closure
