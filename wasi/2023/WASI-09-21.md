...
**Petr Penzin**: I like that this is required to be implemented using `fetch`. Generally how does this compare to fetch.
...
**Petr Penzin**: Easier to see which parts of the web are mappable and which are not. Since WASI does not make this a hard requirement. 
