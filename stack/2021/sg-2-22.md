...
RT: not sure the multicore ml paper had effect signatures. Dan’s paper does. The one that you linked by Andrew Myers et al had explicitly effect signatures.

LI: explicit so you didn’t get confused, you didn’t mean to handle this effect…

RT: talking about lexically scoped effect handlers by Andrew et al.
...
RT: Right, you need that when you have precise effect systems. For our needs it looks like we just need a course grained effect system.
