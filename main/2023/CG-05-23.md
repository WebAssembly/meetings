...
RH: That was my understanding of the brittleness, when you have an import base scheme you have to specify how that works. If there’s a WebAssemly.string type, you have to specify what it does, e.g. if someone monkeypatches the methods then everything is different
