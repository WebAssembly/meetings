...
Discussion on Multibyte Access to Array i8. 20-30 minutes. (no scheduling constraints)

Update on [`<wasm-compat>`](https://www.npmjs.com/package/wasm-compat), the [News](https://webassembly.org/news/) section, and general [website Issues](https://github.com/WebAssembly/website/issues). 30 minutes. (Schedule on Tuesday).

TBD

#### Wednesday, October 29

Presenting about the creation of wasm_of_ocaml, and it's use in production web apps. 30 minutes. (no scheduling constraints)

Update on the ESM Integration, 20-30 minutes. (no scheduling constraints)
