...
AR: this is something we screwed over other proposals
...
AR: must be a LEB but no redundant bytes.
...
#### Continuations & effect handlers as typed stacks ([issue](https://github.com/WebAssembly/design/issues/1359
)) (Daniel Hillerström, Daan Leijen, Sam Lindley, Matija Pretnar, Andreas Rossberg, KC Sivaramakrishnan) [20 min]
