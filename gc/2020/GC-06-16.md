...
JK: Compiling from source is not too hard. You can use JSVU, you can get fairly up-to-date binary snapshots. Also can use Chrome canary (24-hour latency)
