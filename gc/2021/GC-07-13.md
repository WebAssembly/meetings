...
AR: No, these components could be anywhere on the range of coupling.
...
AR: I’m talking about a module system where you’re not explicitly instantiating modules. The instantiation is an implementation detail.
...
AR: Yes, but then you have to downcast in the function and the caller and callee still have to agree on the type structure.
