...
1. Proposals and discussions
    ...
    1. Web platform test repository, discussion, and poll (Ben Titzer).
       ...
       1. Discussion of proposals
           1. Strawperson A: Change status quo, WPT becomes the source of truth
           ...
           1. Strawperson B: Preserve status quo, add additional mirroring in WPT of WASM spec repository
