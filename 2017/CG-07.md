...
* Tuesday - July 18
    ...
    1. Proposals and discussions
        ...
        1. Multiple return values and generalised block signatures (Andreas Rossberg, link TBD)
            1. Generalising function and instruction types to multiple outputs
            1. Generalising block types to multiple outputs & inputs
            1. Extending the binary encoding for block types
            1. Discussion: Do we need a `pick` instruction immediately? Alternatives?
        1. Tail calls (Andreas Rossberg, link TBD)
            1. Strawman proposal
            1. Discussion: Priority, timeline?
            1. Discussion: What opcode scheme should we pick?
    ...
    1. Proposals and discussions
        1. [GC / managed data support](https://github.com/WebAssembly/gc/) (Andreas Rossberg) **discussed all-day Wednesday**
            1. Discuss motivation and general design space
               * goals & non-goals
               * pros, cons, & issues of implementing user-land GC with Wasm as is
               * pros, cons, & issues of adding hooks to support user-land GC
               * pros, cons, & issues of making GC built-in
               * should we provide one soultion, the other, multiple ones?
